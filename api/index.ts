...
// Default/Initial Catalog Data defined directly to make the Vercel function 100% self-contained
...
app.get(["/api/catalog", "/catalog", "/api/index/catalog"], (req, res) => {
  res.json(getCatalog());
});

app.post(["/api/catalog", "/catalog", "/api/index/catalog"], (req, res) => {
...
app.post(["/api/catalog/reset", "/catalog/reset", "/api/index/catalog/reset"], (req, res) => {
